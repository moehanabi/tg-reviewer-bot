...
async def ban_user(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    user_data = BannedUserModel(user_id=user, user_name=username, user_fullname=fullname, banned_reason=" ".join(result),
...
async def get_banned_user_info(context: ContextTypes.DEFAULT_TYPE, user: Banned_user):
